          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <Link to="/login?role=producer" className="glass-card rounded-xl sm:rounded-2xl overflow-hidden floating group block" style={{ animationDelay: `0s` }}>
              ...
              <div className="p-4 sm:p-6 text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-green-400 to-cyan-400 rounded-full flex items-center justify-center text-2xl sm:text-3xl mb-3 sm:mb-4 mx-auto">🏭</div>
                ...
                <ul className="text-left space-y-1 sm:space-y-2 mb-4 sm:mb-6">
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Submit production certificates</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Track credit generation</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Monitor facility performance</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Access production analytics</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Manage credit inventory</li>
                </ul>
            ...
            <Link to="/login?role=buyer" className="glass-card rounded-xl sm:rounded-2xl overflow-hidden floating group block" style={{ animationDelay: `0.5s` }}>
              ...
              <div className="p-4 sm:p-6 text-center">
                ...
                <ul className="text-left space-y-1 sm:space-y-2 mb-4 sm:mb-6">
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Browse credit marketplace</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Purchase verified credits</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Retire credits for reporting</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Track purchase history</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Generate compliance reports</li>
                </ul>
            ...
            <Link to="/login?role=certifier" className="glass-card rounded-xl sm:rounded-2xl overflow-hidden floating group block" style={{ animationDelay: `1s` }}>
              ...
              <div className="p-4 sm:p-6 text-center">
                ...
                <ul className="text-left space-y-1 sm:space-y-2 mb-4 sm:mb-6">
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Review production certificates</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Verify hydrogen credentials</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Approve credit issuance</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Conduct facility audits</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Generate audit reports</li>
                </ul>
            ...
            <Link to="/login?role=admin" className="glass-card rounded-xl sm:rounded-2xl overflow-hidden floating group block" style={{ animationDelay: `1.5s` }}>
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-green-400 to-cyan-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
              <div className="p-4 sm:p-6 text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-green-400 to-cyan-400 rounded-full flex items-center justify-center text-2xl sm:text-3xl mb-3 sm:mb-4 mx-auto">⚙️</div>
                ...
                <ul className="text-left space-y-1 sm:space-y-2 mb-4 sm:mb-6">
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>System management</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>User administration</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Monitor platform integrity</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Generate system reports</li>
                  <li className="flex items-start text-xs sm:text-sm text-gray-300"><span className="text-green-400 mr-2 mt-1 font-bold flex-shrink-0">✓</span>Compliance oversight</li>
                </ul>
