...
export class MetaMaskService {
  ...
  async requestAccounts() {
    ...
    try {
      ...
      toast.success(`Connected to MetaMask! Account: ${accountDisplay}`);
  ...
  async checkNetwork() {
    ...
    try {
      ...
      if (currentNetwork !== expectedNetwork) {
        const message = `Wrong Network! Please switch to ${this.networkName}. Current: ${this.getNetworkName(currentNetwork)}`;
